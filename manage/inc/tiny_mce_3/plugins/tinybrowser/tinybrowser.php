...
if(session_id() != '')
	{
	if(!isset($tinybrowser['sessioncheck']) || !isset($_SESSION[$tinybrowser['sessioncheck']]))
		{
		echo TB_DENIED;
		exit;
		}
...
$thumbpath = $tinybrowser['link'][$typenow].$foldernow; //$thumbpath = $tinybrowser[$tinybrowser['thumbsrc']][$typenow].$foldernow;
