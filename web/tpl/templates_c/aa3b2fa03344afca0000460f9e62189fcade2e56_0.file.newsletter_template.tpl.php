...
?>ul.sessions {min-height: 0!important;}</style></head><body class="SL_body"><table class="full" cellspacing="0" cellpadding="0"><thead><tr class="small-logo"><td><a class="logo hide-med" href="https://shorelinecinema.co.nz/" style="margin:0 auto;"><img src="https://shoreline.nz/tpl/inc/img/sl_logo.png" class="sl-logo-sm" width="316"></a></td></tr></thead></table><table class="full wrapper" cellspacing="0" cellpadding="0"><tbody><?php if ($_smarty_tpl->tpl_vars['editorial']->value) {?><tr class="featured"><td style="color:#ffffff;"><?php echo $_smarty_tpl->tpl_vars['editorial']->value;?>
</td></tr><?php }
if ($_smarty_tpl->tpl_vars['ns']->value && !$_smarty_tpl->tpl_vars['no_movies']->value) {?><tr class="information"><td><h1 style="font-weight:400;">Weekly Session Times</h1></td></tr><tr><td><table class="movie-times" cellspacing="0" cellpadding="10"><tbody><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ns']->value, 'n', false, NULL, 'n', array (
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['n']->value) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?><tr><td><br><h1>Contact Us</h1><p>Please use the information below to contact us if you have any questions about our cinema including venue hire enquiries.</p><!--email_off--><p><strong>Email</strong> for general enquiries:<br><a href="mailto:escape@shorelinecinema.co.nz">escape@shorelinecinema.co.nz</a></p><!--/email_off--><p><strong>Phone</strong> for the cinema and reservations: <br>(04) 902 8070</p><p><strong>Address</strong> for written correspondence:<br>PO Box 414, Waikanae 5036, New Zealand</p></td></tr></tbody></table></td></tr><?php }?></tbody><tfoot><tr><td class="footer"><p style="text-align:center;">To unsubscribe from this email newsletter, <a href="<!--unsub-->" id="unsubscribe">click here</a>.<br>While every attempt is made to ensure this website is accurate, we are not liable for any omissions or errors.<br>Web design and content &copy; <?php echo date('Y');?>
