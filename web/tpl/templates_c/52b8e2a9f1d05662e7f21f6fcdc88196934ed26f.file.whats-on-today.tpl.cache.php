<?php /* Smarty version Smarty-3.1.13, created on 2019-10-03 14:49:15
...
)<?php }?><?php if ($_smarty_tpl->tpl_vars['st']->value['label']){?> <em>(<?php echo $_smarty_tpl->tpl_vars['st']->value['label'];?>
)</em><?php }?><?php } ?></strong></p><a class="btn dark" href="/movies/<?php echo $_smarty_tpl->tpl_vars['s']->value['movie_id'];?>
